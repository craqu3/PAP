...
-- A despejar estrutura para tabela pap.app_ratings
CREATE TABLE IF NOT EXISTS `app_ratings` (
  ...
  `stars` smallint DEFAULT NULL,
  `feedback` smallint DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- A despejar dados para tabela pap.app_ratings: ~0 rows (aproximadamente)
...
-- A despejar estrutura para tabela pap.restaurant
CREATE TABLE IF NOT EXISTS `restaurant` (
  `ID` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- A despejar dados para tabela pap.restaurant: ~0 rows (aproximadamente)
